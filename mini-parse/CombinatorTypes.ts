...
export type ResultFromArg<A extends CombinatorArg> = A extends
  Parser<any, infer R> ? R
  : A extends string ? string
  : A extends () => Parser<any, infer R> ? R
  : never;

/** Result value type returned by a parser specified by a CombinatorArg */
export type InputFromArg<A extends CombinatorArg> = A extends
  Parser<infer R, any> ? R

...
export interface VirtualModuleSet {
  /** functions to create modules, keys are virtual module names. */
  generators: Record<string, VirtualModuleFn>;

  /** cache of wesl code generated by virtualModule functions */

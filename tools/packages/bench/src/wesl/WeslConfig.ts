import { createBaseConfig, type BenchConfig } from "../BenchConfig.ts";
...
export function isWeslConfig(config: BenchConfig): config is BenchConfig & { extension: WeslConfigExtension } {
  return config.extension !== undefined && 

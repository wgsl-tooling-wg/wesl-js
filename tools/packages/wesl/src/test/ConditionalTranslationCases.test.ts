...
test("@if on function const declaration", ctx => caseTest(ctx));
test("@if on function variable declaration", ctx => caseTest(ctx));
test("@if on assignment statement", ctx => caseTest(ctx));
test("@if on increment statement", ctx => caseTest(ctx));
test("@if on decrement statement", ctx => caseTest(ctx));
